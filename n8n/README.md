...
- `audit-clarification-matcher.json` อ่านไฟล์ชี้แจงวันละครั้งเวลา 09:30 น. จับคู่กับ Exception ปัจจุบัน และปิดอัตโนมัติเฉพาะเคสที่ตรงชัดเจนพร้อมข้อความยืนยันว่าแก้ไขแล้ว
...
- `audit-telegram-notifications.json` ส่งสรุป Telegram ตามรอบงาน 08:15, 17:05 และ 19:15 น. โดยไม่ยิงรายชั่วโมง
...
4. เมื่อผลถูกต้องจึง Publish/Activate ให้ทำงานวันละครั้งเวลา 09:30 น. (Asia/Bangkok)
...
4. Workflow ส่งสรุปตามรอบงานเวลา 08:15, 17:05 และ 19:15 น. ตามเขตเวลา Asia/Bangkok โดยแสดงไฟล์ใหม่ จำนวนคิว งานสำเร็จ งานผิดพลาด และรายการไฟล์ที่ขาด.
5. Schedule เดิมแบบรายชั่วโมงและสรุปเวลา 23:30 น. ถูกปิด เพื่อลด execution ที่ไม่จำเป็น; Gmail ingest ยังทำงานเมื่อมีเมลใหม่ตามปกติ.
