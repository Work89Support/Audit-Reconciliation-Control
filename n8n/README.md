...
5. ตัวอ่าน PDF/XLSX และ engine จับคู่ยังทำงานในหน้าเว็บที่ล็อกอินอยู่ จึงต้องเปิดหน้า Dashboard/Cloud ไว้สำหรับ worker รุ่นนี้. หากต้องการให้ประมวลผลแบบไม่มีเบราว์เซอร์ ต้องย้าย parser ไปเป็น Edge Function/worker ในเฟสถัดไป; n8n ชุดนี้ดูแลคิวและสถานะอย่างถาวรแล้ว.
