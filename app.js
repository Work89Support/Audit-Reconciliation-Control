...
const AUDIT_COMPANY_GROUPS = Object.freeze([
  {
    ...
    rules: [
      ...
      "PM AT เก็บรหัสสองช่องแยกกัน: id คอลัมน์ A เป็น P2C... และ _id เป็น 6aa...; ฝั่ง BO แยกเฉพาะรหัส 6aa... หลัง Sapan:/Spean: เหมือน Text to Columns และตัดคำอธิบายที่ตามหลังออก",
      "กฎ Sapan/_id ใช้กับ PM ถอนของ XB ที่มี _id เช่น AT/AZ/CP/M: _id ฝั่ง PM ต้องตรงกับรหัสที่แยกจากหมายเหตุ BO และยอดจริงต้องตรงกันแบบคู่ 1:1 จึงปิดได้ แม้เวลา/ชื่อ Provider เดิมคลาดเคลื่อน",
