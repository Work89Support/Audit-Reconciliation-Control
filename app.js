...
const AUDIT_COMPANY_GROUPS = Object.freeze([
  {
    ...
    rules: [
      ...
      "PM AT เก็บรหัสสองช่องแยกกัน: id คอลัมน์ A เป็น P2C... และ _id เป็น 6aa...; ฝั่ง BO ถอนค้นหา _id ภายในหมายเหตุ Sapan แม้มีข้อความอื่นต่อท้าย",
      "กฎ Sapan/_id ใช้กับ PM ถอนของ XB ที่มี _id เช่น AT/AZ/CP/M โดยต้องตรงบริษัท Provider ทิศทางและยอด และเป็นคู่ 1:1 เท่านั้น",
