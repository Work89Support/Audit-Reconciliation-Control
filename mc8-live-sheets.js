...
(function(root){
  ...
  function rulePanel(company){
    ...
    return `<details class="mc8-requirements"><summary>เงื่อนไขกระทบยอดของกลุ่ม XB</summary><ul><li>จับคู่ภายในบริษัท/บัญชี/Provider/ทิศทางเดียวกัน</li><li>PM ฝากยึด paymentTime ก่อน และใช้ expiredTime เมื่อไม่มี paymentTime</li><li>PM ถอนยึด updateTime · ยอดฝากใช้ realAmount · ยอดถอนใช้ช่องเงินจริงของ Provider</li><li>PM AT: id คอลัมน์ A เก็บ P2C... แยกจาก _id ที่เก็บ 6aa...</li><li>BO ถอน: ค้นหา _id 6aa... ภายในหมายเหตุ Sapan แม้มีคำอื่นต่อท้าย แล้วตรวจ Provider + ทิศทาง + ยอด + คู่ 1:1 ก่อนปิด</li><li>กฎ Sapan/_id ใช้กับ AT/AZ/CP/M ที่มี _id เพื่อไม่ให้เคสหลุดเพราะเวลาไม่ตรง</li><li>คู่ที่ชัดเจนปิดได้ทันที; คู่ซ้ำ ข้ามวัน หรือหลักฐานไม่ครบจะแสดงไว้ให้ Audit ตรวจ</li></ul></details>`;
  }
